<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPatientInfo.aspx.cs" Inherits="LR_Station.AddPatientInfo" %>
...
<body runat="server">
    ...
    <div class="appHeader">
        <div class="left">
            <a href="?id=BtnHeaderBack" class="headerButton">
                ...
                <form runat="server" class="needs-validation">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="txtAdmitAt">Admit At</label>
                            <input runat="server" type="text" class="form-control" id="txtAdmitAt" readonly>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                            <div class="valid-feedback">Looks good!</div>
                            <div class="invalid-feedback">Please enter Patient HN.</div>
                        </div>
                    </div>
                    
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="txtBed">BED</label>
                            <input runat="server" type="text" class="form-control" id="txtBed" readonly>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                            <div class="valid-feedback">Looks good!</div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input runat="server" type="text" class="form-control" id="txtHN" required>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                            <div class="valid-feedback">Looks good!</div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            ...
                            <input runat="server" type="text" class="form-control" id="txtName" required>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                            <div class="valid-feedback">Looks good!</div>
...
<%--                    <div class="form-group boxed">
                    ...
                    <div class="mt-2">
                        ...
                        <asp:Button ID="btnNext" runat="server" class="btn btn-primary btn-block me-1 mb-1" Text="NEXT" OnClick="btnNext_Click1"/>
                        <asp:Button ID="btnCancel" runat="server" class="btn btn-secondary btn-block me-1 mb-1" Text="DISCARD" OnClick="btnCancel_Click1"/>
                    </div>
...
<%--                                        <asp:Button ID="btnAddANC" runat="server" class="btn btn-text-primary" Text="ADD" OnClick="btnAddANC_Click"></asp:Button>--%>
                                    </div>
                                </div>
                            </div>
                        </div>
