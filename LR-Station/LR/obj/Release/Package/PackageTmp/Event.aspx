<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="Event.aspx.cs" Inherits="LR_Station.Event" %>
    ...
    <div id="appCapsule">
        <form runat="server" method="post">
            <div class="section inset mt-2">
                <div class="row">
                    <div class="col">
                        <div class="section-title">Waiting Covid Reault</div>
                                        ...
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                <div class="in">
                                                    ...
                                                    <div><%# string.Format("{0}" ,Eval("bed")) %></div>
                                                ...
                                                <div class="row">
                                                    <div class="wide-block pt-2 pb-1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <p>
                                                                    <a href="<%# string.Format("EditPatient.aspx?hn={0}&name={1}", Eval("hn"), Eval("name")) %>" class="headerButton">
                                                            ...
                                                            <div class="col">
                                                                <p>
                                                                    <a href="<%# string.Format("AddEvent.aspx?hn={0}&name={1}", Eval("hn"), Eval("name")) %>" class="headerButton">
                                                                        <span class="btn btn-primary rounded shadowed">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <p>
                                                                    <a href="<%# string.Format("PVChart.aspx?hn={0}", Eval("hn")) %>" class="headerButton">
                                                                        <span class="btn btn-primary rounded shadowed">
                                                            ...
                                                            <div class="col">
                                                                <p>
                                                                    <a href="<%# string.Format("http://192.168.2.115:8080/bed/{0}/40", Eval("bed")) %>" class="headerButton" target="_blank">
                                                                        <span class="btn btn-primary rounded shadowed">
                                                        ...
                                                        <p>
                                                            <a href="<%# string.Format("EndWithDelivery.aspx?hn={0}&name={1}", Eval("hn"), Eval("name")) %>" class="headerButton">
                                                                <span class="btn btn-primary rounded shadowed">
                                                                    <ion-icon name="caret-forward-outline"></ion-icon>
                                                                    End Case with Delivery</span>
                                                            </a>
                                                        </p>
                                                        <p>
                                                            <a href="<%# string.Format("EndWithoutDelivery.aspx?hn={0}&name={1}", Eval("hn"), Eval("name")) %>" class="headerButton">
                                                                <span class="btn btn-primary rounded shadowed">
                                                                    <ion-icon name="caret-forward-outline"></ion-icon>
                                                                    End Case without Delivery</span>
                                                            </a>
                                                        </p>
                                                    </div>
                                                    <div class="wide-block pt-2 pb-1">
                    ...
                    <div class="col">
                        <div class="section-title">No Covid</div>
