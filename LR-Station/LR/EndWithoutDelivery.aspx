<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="EndWithoutDelivery.aspx.cs" Inherits="LR_Station.EndWithoutDelivery" %>
...
<body runat="server">
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">End Case Without Deliver</div>
    </div>
    <!-- * App Header -->
        ...
        <form runat="server" class="needs-validation">
            <div class="section full mt-2 mb-2">
                ...
                <div class="wide-block pt-2 pb-2">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="cbxDeliver">Deliver?</label>
                            <select runat="server" class="form-control custom-select" id="cbxDeliver">
