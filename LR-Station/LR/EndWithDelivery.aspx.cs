...
{
    public partial class EndWithDelivery : System.Web.UI.Page
    {
        ...
        private async void EndCaseWithDeliver()
        {
            try
            {
                if ((txtHN.Text != string.Empty && txtNAME.Text != string.Empty) || (txtHN.Text != null && txtNAME.Text != null))
                {
                    ...
                    EndCaseWithDeliver parameter = new EndCaseWithDeliver()
                    {
                        hn = txtHN.Text,
                        name = txtNAME.Text,
                        date = datetime,
                        EFW = txtEFW.Value,
                        AGPAR = txtAPGAR.Value,
                        Follow = cbxFallow.Value
                    };
                    ...
                    {
                        string RestURL = string.Format("{0}/EndCaseWithDelivery/", LR.Properties.Settings.Default.API);
