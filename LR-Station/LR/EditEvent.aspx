<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="EditEvent.aspx.cs" Inherits="LR.EditEvent" %>
...
<body runat="server">
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Edit Event</div>
    </div>
    <!-- * App Header -->
...
<%--                    <div class="form-group boxed">
                    ...
                    <div class="section-title">Type Event</div>
                    <div class="btn-group" role="group">
                        <input runat="server" type="radio" class="btn-check" name="btnradios" id="btnradioa1" value="EVENT">
                ...
                <div class="wide-block pt-2 pb-2">
                    ...
                    <div class="mt-2">
                        ...
                        <asp:Button ID="btnSubmit" runat="server" class="btn btn-primary btn-block me-1 mb-1" Text="SUBMIT"></asp:Button>
                        <asp:Button ID="btnCancel" runat="server" class="btn btn-secondary btn-block me-1 mb-1" Text="DISCARD"></asp:Button>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <div class="btn-list">
                                        ...
                                        <asp:Button ID="btnDiscard" class="btn btn-text-secondary btn-block" runat="server" Text="DISDARD" />
                                    </div>
                                </div>
                            </div>
                        </div>
